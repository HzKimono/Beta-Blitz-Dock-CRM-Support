...
<div class="blitz-dock-channels">
	...
	<form method="post" action="<?php echo esc_url( $action_url ); ?>" class="blitz-dock-channels__form">
		...
		<div class="blitz-dock-field">
				<label for="blitz-channel-type" class="blitz-dock-label">
		...
		<div class="blitz-dock-channels__form-row">
		<div class="blitz-dock-field">
				<label for="blitz-channel-url" class="blitz-dock-label">
					<?php esc_html_e( 'Channel Link', 'blitz-dock' ); ?>
				</label>
		...
		<div class="blitz-dock-channels__form-row">
		<div class="blitz-dock-field">
				<label for="blitz-channel-status" class="blitz-dock-label">
					<?php esc_html_e( 'Status', 'blitz-dock' ); ?>
				</label>
